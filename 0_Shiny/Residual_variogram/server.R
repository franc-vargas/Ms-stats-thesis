...
#     .by=c(codigo, nombre_region,especie, cycle)) |>o
#   summarize(
#     max.carga_total = mean(max.carga_total, na.rm = T),
#     max.adultos_totales = mean(max.adultos_totales, na.rm = T),
...
output$LC.Distance.Lagos <- renderPlot({
  plot(x = semivariog.list.Lagos()$LeastCost$plot.data$lag,
       y = semivariog.list.Lagos()$LeastCost$plot.data$response,
       xlab = "Distance", ylab = "Semivariance",
       main = "Least-Cost")
})

output$Cosine.Distance.Lagos <- renderPlot({
  plot(x = semivariog.list.Lagos()$Cosine$plot.data$lag,
       y = semivariog.list.Lagos()$Cosine$plot.data$response,
       xlab = "Distance", ylab = "Semivariance",
       main = "Cosine")
})
output$Geodesic.Distance.Lagos <- renderPlot({
  plot(x = semivariog.list.Lagos()$Geodesic$plot.data$lag,
       y = semivariog.list.Lagos()$Geodesic$plot.data$response,
       xlab = "Distance", ylab = "Semivariance",
       main = "Geodesic")
})
output$Haversine.Distance.Lagos <- renderPlot({
  plot(x = semivariog.list.Lagos()$Haversine$plot.data$lag,
       y = semivariog.list.Lagos()$Haversine$plot.data$response,
       xlab = "Distance", ylab = "Semivariance",
       main = "Haversine")
})
output$VincentyEllipsoid.Distance.Lagos <- renderPlot({
  plot(x = semivariog.list.Lagos()$VincentyEllipsoid$plot.data$lag,
       y = semivariog.list.Lagos()$VincentyEllipsoid$plot.data$response,
       xlab = "Distance", ylab = "Semivariance",
       main = "Vincenty-Ellipsoid")
})
output$Rhumb.Distance.Lagos <- renderPlot({
  plot(x = semivariog.list.Lagos()$Rhumb$plot.data$lag,
       y = semivariog.list.Lagos()$Rhumb$plot.data$response,
       xlab = "Distance", ylab = "Semivariance",
       main = "Rhumb")
})
    ...
    output$LC.Distance.Aysen <- renderPlot({
      plot(x = semivariog.list.Aysen()$LeastCost$plot.data$lag,
           y = semivariog.list.Aysen()$LeastCost$plot.data$response,
           xlab = "Distance", ylab = "Semivariance",
           main = "Least-Cost")
    })

    output$Cosine.Distance.Aysen <- renderPlot({
      plot(x = semivariog.list.Aysen()$Cosine$plot.data$lag,
           y = semivariog.list.Aysen()$Cosine$plot.data$response,
           xlab = "Distance", ylab = "Semivariance",
           main = "Cosine")
    })
    output$Geodesic.Distance.Aysen <- renderPlot({
      plot(x = semivariog.list.Aysen()$Geodesic$plot.data$lag,
           y = semivariog.list.Aysen()$Geodesic$plot.data$response,
           xlab = "Distance", ylab = "Semivariance",
           main = "Geodesic")
    })
    output$Haversine.Distance.Aysen <- renderPlot({
      plot(x = semivariog.list.Aysen()$Haversine$plot.data$lag,
           y = semivariog.list.Aysen()$Haversine$plot.data$response,
           xlab = "Distance", ylab = "Semivariance",
           main = "Haversine")
    })
    output$VincentyEllipsoid.Distance.Aysen <- renderPlot({
      plot(x = semivariog.list.Aysen()$VincentyEllipsoid$plot.data$lag,
           y = semivariog.list.Aysen()$VincentyEllipsoid$plot.data$response,
           xlab = "Distance", ylab = "Semivariance",
           main = "Vincenty-Ellipsoid")
    })
    output$Rhumb.Distance.Aysen <- renderPlot({
      plot(x = semivariog.list.Aysen()$Rhumb$plot.data$lag,
           y = semivariog.list.Aysen()$Rhumb$plot.data$response,
           xlab = "Distance", ylab = "Semivariance",
           main = "Rhumb")
    })
min(shape_aysen$coordinates[,1])
min(shape_aysen$coordinates[,2])
